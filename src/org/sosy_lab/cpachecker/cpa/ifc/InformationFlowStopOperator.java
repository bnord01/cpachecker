 ...
 */
public class InformationFlowStopOperator implements StopOperator {
  private StopOperator childStopOperator;
  public InformationFlowStopOperator(StopOperator pChildStopOperator) {
    this.childStopOperator = pChildStopOperator;
  }
  @Override
